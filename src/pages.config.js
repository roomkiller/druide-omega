 ...
 *
 * Toutes les pages sont chargées en imports directs (plus de lazy loading)
 * afin d'éliminer les spinners Suspense et les blocages de chargement de chunks.
 * Le Layout reste chargé immédiatement car il enveloppe toutes les pages.
 *
