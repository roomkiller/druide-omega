    ...
    <AnalyticsProvider currentPage={currentPageName}>
      ...
      <AccessibilityWrapper>
        <div className="flex h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
          ...
          {/* Bouton flottant pour déplier/replier le sidebar (Desktop - toutes pages) */}
          <motion.button
            ...
            className={`hidden lg:flex fixed top-1/2 -translate-y-1/2 z-50 items-center gap-2 px-2 py-3 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 border border-purple-400/50 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300 ${sidebarCollapsed ? 'left-2' : 'left-[280px]'}`}
