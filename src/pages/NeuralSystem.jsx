...
export default function NeuralSystem() {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-slate-50 to-cyan-50 overflow-hidden">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-4">
              <div className="min-w-[56px] min-h-[56px] w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl shadow-lg flex items-center justify-center">
                <Network className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">{t('neural.title')}</h1>
            ...
            {modules.length === 0 && (
              <Button
                ...
                className="min-h-[48px] w-full sm:w-auto bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 touch-target"
              >
          ...
          <Tabs defaultValue="modules" className="w-full">
            <ScrollArea className="w-full mb-6 whitespace-nowrap">
              <TabsList className="inline-flex bg-white">
                <TabsTrigger value="modules" className="min-h-[48px] touch-target">{t('neural.modules')}</TabsTrigger>
                <TabsTrigger value="network" className="min-h-[48px] touch-target">{t('neural.network')}</TabsTrigger>
                <TabsTrigger value="performance" className="min-h-[48px] touch-target">
                  <span className="hidden sm:inline">{t('neural.performance')}</span>
