            ...
            <ScrollArea className="w-full mb-8">
              <TabsList className="inline-flex bg-white shadow-md">
                <TabsTrigger value="core" className="min-h-[44px] touch-target">
                  ...
                  <span className="hidden sm:inline">Principaux</span>
                </TabsTrigger>
                <TabsTrigger value="secondary" className="min-h-[44px] touch-target">
                  <Sparkles className="w-4 h-4 mr-2" />
                  <span className="hidden sm:inline">Secondaires</span>
                </TabsTrigger>
            ...
            <div className="space-y-4 text-sm text-slate-700 bg-white rounded-lg p-6 border border-red-200">
              ...
              <div className="space-y-3">
                ...
                <p>
                  ...
                  licence ou abonnement aux <strong>modules principaux</strong>, aux <strong>modules secondaire</strong> et aux <strong>modules IA avancés</strong> de la plateforme Druide Omega, 
