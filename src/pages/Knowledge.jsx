...
export default function Knowledge() {
  ...
  const { data: knowledgeBases = [], isLoading: rawLoading } = useQuery({ // Changed isLoading to isLoading: rawLoading
    queryKey: ['knowledgeBases'],
    queryFn: () => base44.entities.KnowledgeBase.list('-created_date', 1000),
    initialData: hub.knowledgeBases || [],
  });

  const isLoading = useMinimumLoadingTime(rawLoading); // New line
  ...
  return (
    ...
    </PageTransition> // Closing PageTransition
  );
}
