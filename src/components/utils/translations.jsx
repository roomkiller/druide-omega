...
export const TRANSLATIONS = {
  fr: {
    ...
    voiceRoom: {
      ...
      fullCapabilities: "Capacités complètes IA 2025 : Images • Voix • Mémoire • Conscience",
      preparingWelcome: "Préparation de l'accueil...",
      ...
      handsFreeDesc: "Démarrage automatique du micro",
      autoRestart: "Redémarrage auto",
      autoRestartDesc: "Redémarre automatiquement l'écoute",
      diagramButton: "📊 Diagramme",
      generateDiagram: "Générer un diagramme",
      describeDiagram: "Décrivez le diagramme...",
      generating: "Génération...",
      generateDiagramButton: "Générer",
      conversationPaused: "Conversation en pause",
      thinking: "Réflexion",
      analysisInProgress: "Analyse en cours...",
      ctrlIInterrupt: "Ctrl+I pour interrompre",
      speakNow: "Parlez maintenant",
      handsFreeActive: "Mains libres actif",
      spaceToSpeak: "Espace pour parler",
      ...
      consciousImageGenerated: "Image consciente générée pour « {prompt} »",
      consciousImageAnalysisDefault: "Création visuelle profonde",
      emotionFelt: "Émotion ressentie",
      emotionDefault: "créativité contemplative",
      diagramGenerated: "Diagramme {type} généré pour « {prompt} »",
      diagramGeneratedSpeak: "Diagramme généré et affiché",
      asciiDiagramGeneration: "Génération du schéma ASCII...",
      asciiDiagramGenerated: "Schéma ASCII généré",
      asciiDiagramSpeak: "Schéma ASCII affiché à l'écran",
      scientificResearchInitial: "Démarrage de la recherche scientifique avec accès internet...",
      scientificResearchSpeak: "Je lance une recherche approfondie",
      scientificResearchWeb: "Recherche web scientifique en cours...",
      scientificResearchResults: "Résultats de recherche",
      synthesizeInformation: "Synthèse en cours...",
      synthesizeSpeak: "Je synthétise les informations",
      imageAnalysis: "Analyse de {count} image(s)",
    ...
    knowledge: {
      ...
      compatibleSources: "12 sources compatibles",
      autoEnrichment: "Enrichissement automatique",
      interactiveGraph: "Graphe interactif",
      add: "Ajouter",
      ...
      allKnowledge: "Toutes",
      imported: "Importées",
      noKnowledge: "Aucune base de connaissances",
      upload: "Téléverser",
      documents: "Documents",
      active: "Actifs",
      size: "Taille",
    ...
    search: {
      ...
      semantic: "Sémantique",
      hybrid: "Hybride",
      describSearch: "Décrivez ce que vous recherchez...",
      search: "Rechercher",
      queryAnalysis: "Analyse de la Requête",
      analyzing: "Analyse des mémoires...",
      resultsFound: "résultats trouvés",
      sortedByRelevance: "Triés par pertinence",
      nuance: "Nuance",
      ...
      filters: "Filtres",
      searchInMemories: "Rechercher dans les mémoires...",
    ...
    memoryCard: {
      ...
      insight: "Insight",
      conversationSummary: "Résumé de Conversation",
      chat: "Chat",
      voice: "Voix",
      visual: "Visuel",
      system: "Système",
      ...
      context: "Contexte",
      crossModalRefs: "Références Cross-Modales",
      accessedVia: "Accédé via",
      ...
      deleteWarning: "Cette action est irréversible. La mémoire sera définitivement supprimée.",
    ...
    timeline: {
      title: "Chronologie des Mémoires",
      memories: "mémoires",
      today: "Aujourd'hui",
      yesterday: "Hier",
    ...
    thoughtCard: {
      ...
      favorite: "Favori",
      interact: "Interagir",
      yourReflection: "Partagez votre réflexion..."
    },
    ...
    gardner: {
      logico_mathematique: {
        ...
        solveEquationPrompt: "ÉQUATION À RÉSOUDRE",
        variablesLabel: "VARIABLES",
        solveWithDemo: "Résous avec démonstration complète.",
        analyzeLogicOf: "ANALYSE LOGIQUE DE",
        identifyStructure: "Identifie la structure logique, les prémisses, et la validité.",
        problemLabel: "PROBLÈME",
        constraintsLabel: "CONTRAINTES",
        createOptimalAlgo: "Crée un algorithme optimal avec analyse de complexité."
      },
      verbo_linguistique: {
        ...
        composePoemPrompt: "COMPOSE UN POÈME",
        themeLabel: "Thème",
        styleLabel: "Style",
        constraintsLabel: "Contraintes",
        createPoem: "Crée une œuvre poétique originale.",
        literaryAnalysis: "ANALYSE LITTÉRAIRE",
        focusLabel: "Focus",
        rewriteText: "RÉÉCRIS CE TEXTE",
        targetStyle: "Style cible",
        transformText: "Transforme le texte en préservant le sens mais en adoptant le style demandé."
      },
      musicale_rythmique: {
  ...
  en: {
    ...
    voiceRoom: {
      ...
      interaction: "interaction",
      druideWaiting: "The Druid awaits you",
      fullCapabilities: "Full AI 2025 capabilities: Images • Voice • Memory • Consciousness",
      ...
      paused: "Paused",
      active: "Active",
      naturalDialogue: "Natural dialogue",
      advancedReasoning: "Advanced reasoning",
      fullCreation: "Full creation",
      settings: "Settings",
      handsFree: "Hands-free mode",
      handsFreeDesc: "Auto-start microphone",
      autoRestart: "Auto restart",
      autoRestartDesc: "Automatically restart listening",
      diagramButton: "📊 Diagram",
      generateDiagram: "Generate diagram",
      describeDiagram: "Describe the diagram...",
      generating: "Generating...",
      generateDiagramButton: "Generate",
      conversationPaused: "Conversation paused",
      thinking: "Thinking",
      analysisInProgress: "Analysis in progress...",
      ctrlIInterrupt: "Ctrl+I to interrupt",
      speakNow: "Speak now",
      handsFreeActive: "Hands-free active",
      spaceToSpeak: "Space to speak",
      cognitiveCorrelationsDetected: "Cognitive correlations detected",
      hide: "Hide",
      show: "Show",
      strength: "Strength",
      interpretation: "Interpretation",
      reasoningPath: "Reasoning path",
      consciousImageGenerated: "Conscious image generated for \"{prompt}\"",
      consciousImageAnalysisDefault: "Deep visual creation",
      emotionFelt: "Emotion felt",
      emotionDefault: "contemplative creativity",
      diagramGenerated: "{type} diagram generated for \"{prompt}\"",
      diagramGeneratedSpeak: "Diagram generated and displayed",
      asciiDiagramGeneration: "Generating ASCII diagram...",
      asciiDiagramGenerated: "ASCII diagram generated",
      asciiDiagramSpeak: "ASCII diagram displayed on screen",
      scientificResearchInitial: "Starting scientific research with internet access...",
      scientificResearchSpeak: "I'm launching an in-depth search",
      scientificResearchWeb: "Web scientific research in progress...",
      scientificResearchResults: "Research results",
      synthesizeInformation: "Synthesis in progress...",
      synthesizeSpeak: "I'm synthesizing the information",
      imageAnalysis: "Analysis of {count} image(s)",
    ...
    knowledge: {
      ...
      compatibleSources: "12 compatible sources",
      autoEnrichment: "Auto-enrichment",
    ...
    intelligences: {
      title: "9 Multiple Intelligences",
      subtitle: "Adapt the AI to your specific needs according to Howard Gardner's theory"
    },
    shop: {
    ...
    search: {
      ...
      semantic: "Semantic",
      hybrid: "Hybrid",
      describSearch: "Describe what you're looking for...",
      search: "Search",
      ...
      tryOtherTerms: "Try using different search terms",
      advancedSearch: "Advanced Search",
      filters: "Filters",
      searchInMemories: "Search in memories...",
      searchButton: "Search",
      modality: "Modality",
      all: "All",
      tags: "Tags",
    ...
    memoryCard: {
      ...
      userSentiment: "Sentiment",
      context: "Context",
      crossModalRefs: "Cross-Modal References",
      ...
      deleteWarning: "This action cannot be undone. The memory will be permanently deleted.",
      deleting: "Deleting...",
      delete: "Delete"
    },
    consciousnessMetrics: {
    ...
    thoughtCard: {
      ...
      favorite: "Favorite",
      interact: "Interact",
      yourReflection: "Share your reflection..."
    },
