...
export const FR_CA_TRANSLATIONS = {
  ...
  memoryCard: {
    ...
    linked: "liée(s)",
    emotion: "Émotion",
    userSentiment: "Sentiment utilisateur",
    context: "Contexte",
    crossModalRefs: "Références cross-modales",
    accessedVia: "Consultée via",
    tagsLabel: "Tags",
    modify: "Modifier",
    newTag: "Nouveau tag...",
    save: "Enregistrer",
    ...
    accessed: "Consulté",
    times: "fois",
    deleteMemory: "Supprimer cette mémoire ?",
    deleteWarning: "Cette action est irréversible. La mémoire sera définitivement supprimée de la base de connaissances de l'IA.",
    deleting: "Suppression...",
    delete: "Supprimer"
  },
  timeline: {
    title: "Timeline des Mémoires",
    memories: "mémoires",
    today: "Aujourd'hui",
    yesterday: "Hier",
    ...
    important: "Important",
    accessedTimes: "Accédée {count} fois"
  },
  thoughtCard: {
    level: "Niv.",
    favorite: "Favori",
