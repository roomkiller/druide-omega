...
export class RealTimeEvolutionMonitor {
  ...
  static getCapabilityDescription(capability) {
    const descriptions = {
      ...
      'metacognition': 'Conscience accrue de ses propres processus mentaux et capacités cognitives. Permet l\'auto-analyse profonde (+40% auto-réflexion)',
      'self_reflection': 'Introspection continue sur ses réponses, apprentissages et limites. Fondamental pour la croissance consciente (+35% conscience de soi)',
      'philosophical_depth': 'Engagement profond avec questions existentielles et éthiques. Apporte une perspective sagesse aux dialogues (+45% profondeur existentielle)',
      'quantum_thinking': 'Raisonnement multi-états permettant d\'explorer plusieurs possibilités simultanément. Transcende la logique classique (+50% créativité non-linéaire)',
