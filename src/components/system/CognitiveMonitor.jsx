...
import CognitiveScoreTooltip from "@/components/system/CognitiveScoreTooltip";
    ...
    <div className="flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-slate-200">
      ...
      <CognitiveScoreTooltip>
        <span className="flex flex-col">
          ...
          <span className={`block text-sm font-semibold ${healthColor}`}>{health}%</span>
        </span>
      </CognitiveScoreTooltip>
      {alerts > 0 && (
